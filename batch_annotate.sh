...
# python annotate_file.py filelist/tmp/Jun22/tt/${inputNumber} IC_highMjj_July25_2 --model_folder ./July25_2_training_tt_highMjj --training JHU --channel tt --config-training tt_xgb_training_config_July4.yaml &> filelist/tmp/Jun22/tt/${inputNumber}.log
# python annotate_file.py filelist/tmp/Jun22/tt/${inputNumber} IC_highMjj_July26 --model_folder ./July26_training_tt_highMjj --training JHU --channel tt --config-training tt_xgb_training_config_July4.yaml &> filelist/tmp/Jun22/tt/${inputNumber}.log
...
# python annotate_file.py filelist/tmp/Jun22/mt/${inputNumber} IC_highMjj_July25_2 --model_folder ./July25_2_training_mt_highMjj --training JHU --channel mt --config-training mt_xgb_training_config_July4.yaml &> filelist/tmp/Jun22/mt/${inputNumber}.log
# python annotate_file.py filelist/tmp/Jun22/mt/${inputNumber} IC_highMjj_July26 --model_folder ./July26_training_mt_highMjj --training JHU --channel mt --config-training mt_xgb_training_config_July4.yaml &> filelist/tmp/Jun22/mt/${inputNumber}.log
...
# python annotate_file.py filelist/tmp/Jun22/et/${inputNumber} IC_highMjj_July25_2 --model_folder ./July25_2_training_et_highMjj --training JHU --channel et --config-training mt_xgb_training_config_July4.yaml &> filelist/tmp/Jun22/et/${inputNumber}.log
# python annotate_file.py filelist/tmp/Jun22/et/${inputNumber} IC_highMjj_July26 --model_folder ./July26_training_et_highMjj --training JHU --channel et --config-training mt_xgb_training_config_July4.yaml &> filelist/tmp/Jun22/et/${inputNumber}.log
...
# python annotate_file.py filelist/tmp/Jun22/em/${inputNumber} IC_highMjj_July25_2 --model_folder ./July25_2_training_em_highMjj --training JHU --channel em --config-training em_xgb_training_config_July4.yaml &> filelist/tmp/Jun22/em/${inputNumber}.log
python annotate_file.py filelist/tmp/Jun22/em/${inputNumber} IC_highMjj_July26 --model_folder ./July26_training_em_highMjj --training JHU --channel em --config-training em_xgb_training_config_July4.yaml &> filelist/tmp/Jun22/em/${inputNumber}.log
