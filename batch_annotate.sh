...
python annotate_file.py filelist/tmp/Jun22/tt/${inputNumber} IC_highMjj_July05 --model_folder ./July5_training_tt_highMjj --training JHU --channel tt --config-training tt_xgb_training_config_July4.yaml &> filelist/tmp/Jun22/tt/${inputNumber}.log
